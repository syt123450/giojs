...
可以通过 [configure()](#configure-api) API来设置表面颜色，具体设置方式如下所示：
...
<p align="center">
  <a><img src="https://github.com/syt123450/Gio.js/blob/master/assets/images/document/elements/country_zh.png"/></a>
</p>
...
- `不可点击的国家`
    ...
    可以通过 [disableUnmentioned(true)](#disableunmentioned) API来将未在数据集中提到的数据设置为"不可点击的"， 也可以通过调用 [disableUnmentioned(false)](#disableunmentioned) API来关闭该设置。
...
<p align="center">
  <a><img src="https://github.com/syt123450/Gio.js/blob/master/assets/images/document/elements/line_zh.png"/></a>
</p>
...
可以通过 [configure API](#configure-api) 来设置连接线的颜色，具体设置方法如下所示：
	...
	```
也可以通过 [setInLineColor()](#setInLineColor) API和 [setOutLineColor()](#setOutLineColor) API来动态改变"输入线"和"输出线"的颜色。
...
```
动态设置连接线的颜色需要在调用controller.init()之后才会生效。想要了解更多相关数据设置的细节， 可以查看API文档的 [working with data](#working-with-data) 部分。
...
<p align="center">
  <a><img src="https://github.com/syt123450/Gio.js/blob/master/assets/images/document/elements/background_zh.png"/></a>
</p>

背景是在3D场景中"地球背后"的区域。背景默认的颜色是![background](https://placehold.it/15/000000/000000?text=+) `0x000000`。

背景的颜色可以通过 [configure()](#configure-api) API进行设置，如下所示：
...
```
也可以通过 [setBackgroundColor()](#setbackgroundcolor) API来动态改变背景颜色。
...
<p align="center">
  <a><img src="https://github.com/syt123450/Gio.js/blob/master/assets/images/document/elements/halo_zh.png"/></a>
</p>

光晕是在地球周围的光圈。光晕的默认颜色是![halo](https://placehold.it/15/ffffff/000000?text=+) `0xffffff`.

可以通过 [configure()](#configure-api) API来设置光晕的颜色，具体设置方法如下所示：
...
```
也可以通过 [setHaloColor()](#sethalocolor) API来动态修改光晕颜色。
...
<p align="center">
  <a><img src="https://github.com/syt123450/Gio.js/blob/master/assets/images/document/elements/ocean_zh.png"/></a>
</p>
...
也可以通过 [adjustOceanBrightness](#adjustoceanbrightness) API来动态改变海洋亮度。
...
<p align="center">
  <a><img src="https://github.com/syt123450/Gio.js/blob/master/assets/images/document/elements/stats_zh.png"/></a>
</p>

"性能监控"整合了Threejs的监控组件stats，如果你对这个组件感兴趣，你可以从它的 [github](https://github.com/mrdoob/stats.js/) 仓库中了解更多细节。如果你想要在gio场景中显示这个组件，你可以使用 [enableStats()](#enablestats) API，这个性能监控面板默认会显示在左上角。
